...
import com.example.parental_control_app.viewmodels.manageProfile.TeenTestViewModel

class TeenTestActivity : AppCompatActivity() {
    @OptIn(ExperimentalMaterial3Api::class)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val viewModel = TeenTestViewModel()
                        ...
                        if (loading) {
                            ...
                            if (submitted) {
                                ...
                                LazyColumn(modifier = Modifier.padding(20.dp)) {
                                    item {
                                        Text("Behavioral/Situational Assessment Test for Teens(12-17 Yrs Old)", fontSize = 24.sp, fontWeight = FontWeight.SemiBold)
                                    }
                                    item {
                                        Text(
                                            modifier = Modifier.padding(vertical = 20.dp),
                                            fontSize = 13.sp,
                                            text = "This guide provides a detailed scoring system for the previously presented Behavioral/Situational Assessment Test for Teens. Each scenario response option is assigned points along with a brief explanation. Remember, this is a subjective assessment, and the final interpretation should consider the teen's age, individual circumstances, and developmental stage."
                                        )
                                    }
